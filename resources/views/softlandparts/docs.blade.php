      ...
      <div class="row align-items-center">
        <div class="col-12">
          <div class="row justify-content-center">
            <div class="col-md-7 text-center hero-text" data-aos="fade-up" data-aos-delay="">
              <h1>Informações sobre o AtivReg</h1>
              <h6 style="color: #fff">Escolha uma das secções presentes em baixo:</h6>
              <br>
                <button type="button" class="btn btn-primary"><span>Administradores</span></button>
                <button type="button" class="btn btn-primary"><span>Colaboradores</span></button>
                <button type="button" class="btn btn-primary"><span>Familiares</span></button>
            </div>
            </div>
          </div>
